...
Archive_Dir="/opt/pwrcard/test1/Data_Files_Purge"
echo "$Archive_Dir"
...
fun () {
    ...
    if [[ $FileCount != 0 && "$3" == "NA" ]]; then
		...
		cd $1
		echo "Number of files inside $1 older than $2 : $FileCount"
